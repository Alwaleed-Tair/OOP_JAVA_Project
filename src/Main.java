...
public class Main {
    ...
    public static final String GREEN_COLOR = "\033[92m";
    public static final String CYAN_COLOR = "\033[92m";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print(CYAN_COLOR + "Enter your choice: " + ENDC);
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println(GREEN_COLOR + "Thank you for using the Event Management System. Goodbye!" + ENDC);
                    System.exit(0);
                default:
                    System.out.println(RED_COLOR + "Invalid choice. Please try again." + ENDC);
            }
        }
    }
    ...
    private static void loginAsAdmin() {
        System.out.print(CYAN_COLOR + "Enter admin password: " + ENDC);
    ...
    private static void loginAsOrganizer() {
        System.out.print(CYAN_COLOR + "Enter organizer ID: " + ENDC);
        int id = input.nextInt();
        input.nextLine();
        System.out.print(CYAN_COLOR + "Enter password: " + ENDC);
        String password = input.nextLine();
        ...
        System.out.println(RED_COLOR + "Invalid ID or password." + ENDC);
    }

    private static void loginAsParticipant() {
        System.out.print(CYAN_COLOR + "Enter participant ID: " + ENDC);
        int id = input.nextInt();
        input.nextLine();
        System.out.print(CYAN_COLOR + "Enter password: " + ENDC);
        String password = input.nextLine();
    ...
    private static void addOrganizer() {
        System.out.print(CYAN_COLOR + "Enter new organizer ID: " + ENDC);
        int id = input.nextInt();
        input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new organizer name: " + ENDC);
        String name = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new organizer password: " + ENDC);
        String password = input.nextLine();
    ...
    private static void removeOrganizer() {
        System.out.print(CYAN_COLOR + "Enter organizer ID to remove: " + ENDC);
        int id = input.nextInt();
    ...
    private static void addParticipant() {
        System.out.print(CYAN_COLOR + "Enter new participant ID: " + ENDC);
        int id = input.nextInt();
        input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new participant name: " + ENDC);
        String name = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new participant password: " + ENDC);
        String password = input.nextLine();
    ...
    private static void removeParticipant() {
        System.out.print(CYAN_COLOR + "Enter participant ID to remove: " + ENDC);
        int id = input.nextInt();
    ...
    private static void createEvent() {
        System.out.print(CYAN_COLOR + "Enter event ID: " + ENDC);
        int id = input.nextInt();
        input.nextLine();
        System.out.print(CYAN_COLOR + "Enter event name: " + ENDC);
        String name = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter event date (YYYY-MM-DD): " + ENDC);
        LocalDate date = LocalDate.parse(input.nextLine());
        System.out.print(CYAN_COLOR + "Enter event location: " + ENDC);
        String location = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter event description: " + ENDC);
        String description = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter event organizer name: " + ENDC);
        String organizerName = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter max participants: " + ENDC);
    ...
    private static void deleteEvent() {
        System.out.print(CYAN_COLOR + "Enter event ID to delete: " + ENDC);
        int id = input.nextInt();
    ...
    private static void updateEvent() {
        System.out.print(CYAN_COLOR + "Enter event ID to update: " + ENDC);
        int id = input.nextInt();
        input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new event name: " + ENDC);
        String name = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new event date (YYYY-MM-DD): " + ENDC);
        LocalDate date = LocalDate.parse(input.nextLine());
        System.out.print(CYAN_COLOR + "Enter new event location: " + ENDC);
        String location = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new event description: " + ENDC);
        String description = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new max participants: " + ENDC);
        int maxParticipants = input.nextInt();
    ...
    private static void viewParticipantsForOrganizer(Organizer organizer) {
        System.out.print(CYAN_COLOR + "Enter event ID to view participants: " + ENDC);
        int id = input.nextInt();
    ...
    private static void registerForEvent(Participant participant) {
        System.out.print(CYAN_COLOR + "Enter event ID to register: " + ENDC);
        int id = input.nextInt();
        for (Event event : events) {
            if (event.getEventID() == id) {
    ...
    private static void cancelRegistration(Participant participant) {
        System.out.print(CYAN_COLOR + "Enter event ID to cancel registration: " + ENDC);
        int id = input.nextInt();
        for (Event event : events) {
            if (event.getEventID() == id) {
    ...
    private static void updateParticipantProfile(Participant participant) {
        System.out.print(CYAN_COLOR + "Enter new name: " + ENDC);
        String newName = input.nextLine();
        System.out.print(CYAN_COLOR + "Enter new password: " + ENDC);
